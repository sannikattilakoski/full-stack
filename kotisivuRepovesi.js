...
function getWeatherData () {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=61.18789&lon=26.90196&exclude=hourly,minutely&lang=fi&units=metric&appid=${api_key}`).then(res => res.json()).then(data =>{
