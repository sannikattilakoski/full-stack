...
function getWeatherData () {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=67.96660&lon=24.13330&exclude=hourly,minutely&lang=fi&units=metric&appid=${api_key}`).then(res => res.json()).then(data =>{
