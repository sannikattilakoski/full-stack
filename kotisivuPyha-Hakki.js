...
function getWeatherData () {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=62.85048&lon=25.48914&exclude=hourly,minutely&lang=fi&units=metric&appid=${api_key}`).then(res => res.json()).then(data =>{
